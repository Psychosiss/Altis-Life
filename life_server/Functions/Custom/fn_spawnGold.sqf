...
"MarkerText200" setMarkerText "Debrit d'Or";
"MarkerText200" setMarkerType "mil_warning";
[[5,"<t size='3'><t color='#FFFFFF'>NAUFRAGE</t></t> <br/><t size='1.5'>Une épave a été repérée, vérifiez la zone de <t color='#FFFFFF'>caisses sous-marines d'or</t>. Vérifiez votre carte.</t>"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;