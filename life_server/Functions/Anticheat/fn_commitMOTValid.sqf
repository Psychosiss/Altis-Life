...
if(_index == -1) then
{
	...
	diag_log format["<* ANTICHEAT *> Joueur %1 (id: %2) will receive valid money $%3 (Reason: %5). Updated Zero to %4", _pname,_uid, 
	[_money] call life_fnc_numberText, 
	[_zeromoney + _money] call life_fnc_numberText, _reason];
};