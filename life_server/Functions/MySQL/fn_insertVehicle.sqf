...
_query = format["INSERT INTO vehicles (side, classname, type, pid, alive, active, inventory, color, plate, gear) VALUES ('%1', '%2', '%3', '%4', '1','1','""[]""', '%5', '%6','""[]""')",_side,_className,_type,_uid,_color,_plate];
