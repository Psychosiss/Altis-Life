...
[[[_sp,_type],{life_atmmoney = life_atmmoney + (_this select 0); hint format[("Vous avez vendu ce véhicule pour %1 €"),[(_this select 0)] call life_fnc_numberText];}],"BIS_fnc_call",_unit,false] spawn life_fnc_MP;