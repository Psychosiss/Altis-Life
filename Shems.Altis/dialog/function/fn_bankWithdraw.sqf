...
if(_val > life_atmmoney) exitWith {hint "Vous n'avez pas autant dans votre compte en banque!"};
if(_val < 100 && life_atmmoney > 20000000) exitWith {hint "Vous ne pouvez pas retirer moins de 100 €."};
