class Life_My_Gang_Diag 
{
	...
	//onLoad = "";
	onLoad = "[] spawn {waitUntil {!isNull (findDisplay 2520)}; ((findDisplay 2520) displayCtrl 2523) ctrlSetText format[localize ""Les gangs sont gratuits"",[(getNumber(missionConfigFile >> 'Life_Settings' >> 'gang_price'))] call life_fnc_numberText]};";
...
class Life_Create_Gang_Diag 
{
	...
	movingEnable = false;
	enableSimulation = true;
	onLoad = "[] spawn {waitUntil {!isNull (findDisplay 2520)}; ((findDisplay 2520) displayCtrl 2523) ctrlSetText format[""Les gangs sont gratuits"",[(call life_gangPrice)] call life_fnc_numberText]};";
