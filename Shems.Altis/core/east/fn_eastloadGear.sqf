...
_itemArray = east_gear;
waitUntil {!(isNull (findDisplay 46))};

if(isNil "_itemArray") exitWith {[] call life_fnc_eastDefault;};
if(count _itemArray == 0) exitWith {[] call life_fnc_eastDefault;};
