...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","apple_9","peaches_1","peaches_2","peaches_3","peaches_4","peaches_9","heroin_1","cocaine_1","weed_1","weed_2","lead_1","iron_1","salt_1","sand_1","diamond_1","oil_1","oil_2","rock_1","meth_1","tabac_1","silver_1"];
_zone = "";
...
_item = switch(true) do {
	case (_zone in ["apple_1","apple_2","apple_3","apple_4","apple_9"]): {"apple"};
	case (_zone in ["peaches_1","peaches_2","peaches_3","peaches_4","peaches_9"]): {"peach"};
