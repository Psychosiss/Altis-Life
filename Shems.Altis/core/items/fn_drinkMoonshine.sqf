...
{
	titleText ["Vous ête ailleurs","BLACK OUT"];
	...
	sleep 10;
	life_drink = 0;
	titleText["Que m'est-t-il arrivé","PLAIN"];
	player playMoveNow "amovppnemstpsraswrfldnon";
	[[0,format["%1 est ivre sur la voie publique",profileName]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
