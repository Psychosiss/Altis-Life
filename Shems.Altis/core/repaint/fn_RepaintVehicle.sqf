...
if(life_bargeld < _basePrice) exitWith {hint "Vous n'avez pas 10.000€ Pour repeindre votre véhicule."};
...
if(player != vehicle player) exitWith {titleText["Vous devez sortir du véhicule afin de le peindre!","PLAIN"];};
