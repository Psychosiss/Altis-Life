		...
		switch(true) do
		{
			default
			{
				[
					...
					//[" - - - Restriction de vue","talent_civ_look","talent_civ_vest3","Vous permet de bloquer la vue d'un joueur en 1er personne pendant 1 minute"],
					...
					[" - - Helico Léger","talent_civ_helico1","talent_civ_truck2","Permet d'acheter et d'utiliser le Humming-Bird"],
