...
if(life_cash < _basePrice) exitWith {hint format["Vous n'avez pas assez pour acheter ce vehicule.\n\nIl vous manque %1 $",[_basePrice - life_cash] call life_fnc_numberText];};
