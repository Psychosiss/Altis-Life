...
_text = "<t size='1.5' color='#FFFFFF'>Bourse d'Altis</t><br/>";
...

{
	if(_x in life_market_shortnames) then 
	{
		...
		_text = format["%1<br/><t size='1.2'>%2</t><br/><t size='1.3' color='#FFFFFF'>%3$</t><br/>", _text,_resname, [_price] call life_fnc_numberText];
