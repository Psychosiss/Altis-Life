...
_val = ctrlText 2010;
ctrlShow[2002,false];
if((lbCurSel 2023) == -1) exitWith {hint "Séléctionnez quelqu'un!";ctrlShow[2002,true];};
...
if(!([_val] call fnc_isnumber)) exitWith {hint "Vous devez entrer des chiffres.";ctrlShow[2002,true];};
