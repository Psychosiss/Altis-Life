...
switch _var do
{
	...
	//case "life_inv_goatp": {("")};
	//case "life_inv_sheep": {("")};
	//case "life_inv_sheepp": {("")};
	//case "life_inv_chicken": {("")};
	//case "life_inv_chickenp": {("")};
	//case "life_inv_snakep": {("")};
	//case "life_inv_rabbit": {("")};
	//case "life_inv_rabbitp": {("")};
	//case "life_inv_skinningknife": {("")};
	//case "life_inv_vammo": {("")};
	//case "life_inv_adrenalineShot": {("")};
