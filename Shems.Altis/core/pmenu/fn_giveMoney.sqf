...
{
	hint "You recently robbed the bank! You can't give money away just yet.";
	ctrlShow[2001,true];
};

if(!([_amount] call fnc_isnumber)) exitWith 
{
...
if(parseNumber(_amount) > life_money) exitWith 
{
	hint "You don't have that much to give!";
	ctrlShow[2001,true];
};
