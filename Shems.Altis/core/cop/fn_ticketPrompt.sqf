...
[] spawn
{
	...
	{
		[[0,format["%1 à refusé l'amende.",profileName]],"life_fnc_broadcast",west,false] call life_fnc_MP;
		[[1,format["%1 à refusé l'amende.",profileName]],"life_fnc_broadcast",life_ticket_cop,false] call life_fnc_MP;
	};
};