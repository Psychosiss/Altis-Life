...
player setPos (getMarkerPos "asylum_marker");
...
if(player distance (getMarkerPos "asylum_marker") > 40) then
{
	player setPos (getMarkerPos "asylum_marker");
};
...
[[player,_bad,_time],"life_fnc_jailSysAsylum",false,false] spawn life_fnc_MP;
