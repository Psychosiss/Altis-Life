...
player setPos (getMarkerPos "troll_marker");
...
if(player distance (getMarkerPos "troll_marker") > 40) then
{
	player setPos (getMarkerPos "troll_marker");
};
...
[[player,_bad,_time],"life_fnc_jailSystroll",false,false] call life_fnc_MP;
